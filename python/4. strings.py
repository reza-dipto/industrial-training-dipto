...
info = "Name: taivan reza, Age: 23, Country: BD"


name = info[info.find("Name:") + len("Name:"):info.find(", Age:")]
age = info[info.find("Age:") + len("Age:"):info.find(", Country:")]
country = info[info.find("Country:") + len("Country:"):]
