...
mixed_tuple = ("taivan reza", 24, True, ["Python", "JavaScript"])
...
person_info = {
    ...
    "favorite_coding_languages": mixed_tuple[3]
}
...
print("\nAccessing elements from the tuple via the dictionary:")
print("Name:", person_info["name"])
print("Age:", person_info["age"])
print("Is Student:", person_info["is_student"])
print("Favorite Languages:", ", ".join(person_info["favorite_coding_languages"]))
